# custom_purchase_order_analysis.py
import copy
...
def get_data(filters):
	...
	query = (
		...
		.select(
			...
			po.status,
			po.supplier,
			po.custom_purchase_type,  # Added custom field
			po_item.item_code,
			po_item.qty,
	...
	if filters.get("custom_purchase_type"):
		query = query.where(po.custom_purchase_type == filters.get("custom_purchase_type"))
