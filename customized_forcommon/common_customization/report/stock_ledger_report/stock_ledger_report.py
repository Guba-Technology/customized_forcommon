...
def get_stock_ledger_entries(filters, items):
    from_date = get_datetime(filters["from_date"] + " 00:00:00") if filters.get("from_date") else None
    to_date = get_datetime(filters["to_date"] + " 23:59:59") if filters.get("to_date") else None
    ...
    # Add custom_department filter here:
    if filters.get("custom_department"):
        query = query.where(sle.custom_department == filters.get("custom_department"))
